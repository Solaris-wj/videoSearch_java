...
*/
   ...
   public static void test()
   {
       try
       {
          Base64 b64 = new Base64('-','_','=',128);

          String str="java_base64我";
          //encode
          String str64 = b64.encode(str.getBytes("Unicode"));
          System.out.println(str64);

          //String str64 = "java_base64";
          ...
          System.out.println(new String(theBytes,"Unicode"));
       }
       catch(Exception e)
       {
          e.printStackTrace();
